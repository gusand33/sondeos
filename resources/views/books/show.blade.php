            ...
            <div class="card">
                ...
                <div class="row m-3">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <span class="ms-2 text-danger border-0">*</span>
                        {!! Form::text('author', null, array('class' => 'form-control',"disabled")) !!}
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            {!! Form::number('price', null, array('class' => 'form-control', "disabled")) !!}
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <span class="ms-2 text-danger border-0">*</span>
                        {!! Form::date('publication_date', null, array('class' => 'form-control',"disabled")) !!}
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <span class="ms-2 text-danger border-0">*</span>
                        {!! Form::select('gender_id',$genders, null, array('placeholder'=>'Seleccione', 'class' => 'form-control',"disabled")) !!}
                        <label id="gender_id-error" class="error text-danger" for="gender_id"></label>
                    </div>
                    <div>
                        <a href="{{ route('books.index') }}" class="btn btn-secondary">Volver</a>
                    </div>
                {!! Form::close() !!}
            </div>
        </div>
